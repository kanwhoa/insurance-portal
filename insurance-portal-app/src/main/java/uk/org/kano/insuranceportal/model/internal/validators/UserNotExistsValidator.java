...
/**
 * Make sure the username being being checked does not exist already. Note that in this
 * setup, the "username" and "user ID" are equal.
 * 
 * @see uk.org.kano.insuranceportal.service.UserDetailsServiceImpl
 * @author timh
 *
 */
